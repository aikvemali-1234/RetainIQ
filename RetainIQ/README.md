# RetainIQ — AI-Powered Revision & Quiz Engine
RetainIQ converts study material (PDF/DOCX/PPTX) into interactive quizzes and flashcards, tracks performance, identifies weak concepts and schedules spaced-revision.

## Project Structure
RetainIQ/
├── src/ # application source code (backend, templates)
├── models/ # saved model files (optional)
├── docs/ # documentation PDFs and design docs
├── requirements.txt
├── README.md
└── .gitignore
